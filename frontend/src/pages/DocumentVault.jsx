                                    ...
                                    <>
                                        ...
                                        <div className="grid grid-cols-2 gap-2">
                                            <button
                                                ...
                                                className="flex items-center justify-center gap-1.5 py-1.5 px-2 bg-white border border-slate-200 text-slate-700 hover:bg-slate-50 hover:text-blue-600 rounded-lg text-xs font-bold transition-colors shadow-sm active:bg-slate-100"
                                            >
                                            ...
                                            <div className="relative">
                                                ...
                                                <DocumentUploader
                                                    ...
                                                    customButton={
                                                        <button className="w-full flex items-center justify-center gap-1.5 py-1.5 px-2 bg-blue-50 border border-blue-100 text-blue-700 hover:bg-blue-100 rounded-lg text-xs font-bold transition-colors shadow-sm active:scale-95">
