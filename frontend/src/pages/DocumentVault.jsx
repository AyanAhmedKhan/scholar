                            ...
                            {uploadedDoc ? (
                                <div className="space-y-3">
                                    ...
                                    <div className="relative group/upload">
                                        <div className="absolute inset-0 flex items-center justify-center bg-white/90 opacity-0 group-hover/upload:opacity-100 transition-opacity z-10 rounded-lg">
                                            <span className="text-xs font-medium text-slate-600">Click to replace</span>
                                        </div>
                                        <DocumentUploader
